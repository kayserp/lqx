...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Lqx address\n"
            "  payee          - Print the masternode payout Lqx address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Lqx address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "lqx",               "masternode",             &masternode,             true,  {} },
    { "lqx",               "masternodelist",         &masternodelist,         true,  {} },
    { "lqx",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "lqx",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
