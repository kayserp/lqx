# Linearize
Construct a linear, no-fork, best version of the Lqx blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install lqx_hash

https://github.com/vagnfedora/lqx_hash
...
JSON-RPC server. Running `lqxd` or `lqx-qt -server` will be sufficient.
...
* `input`: lqxd blocks/ directory containing blkNNNNN.dat
