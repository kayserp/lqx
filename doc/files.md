...
* lqx.conf: contains configuration settings for lqxd or lqx-qt
* lqxd.pid: stores the process id of lqxd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by lqxd or lqx-qt
