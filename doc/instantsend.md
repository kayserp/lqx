...
This mechanism has been integrated into Bitcore-Node-Lqx which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/vagnfedora/insight-api-lqx#web-socket-api](https://github.com/vagnfedora/insight-api-lqx#web-socket-api)
* API: [https://github.com/vagnfedora/insight-api-lqx#instantsend-transactions](https://github.com/vagnfedora/insight-api-lqx#instantsend-transactions)
